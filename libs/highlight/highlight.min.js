...
codeBlocks.forEach(codeBlock => {
  ...
  button.style.background = 'linear-gradient(155deg, #dbe4ed, #a6b8cb)';
  ...
  if (window.outerWidth <= iPhoneSEWidth || window.outerWidth <= iPhoneWidth) {
    ...
    button.style.backgroundClip = 'padding-box'; // Ensure background is clipped to the padding box
    ...
    //     padding: 5px; /* Adjust the width of the border */
