...
// Assuming the highlighting code is already rendered

// Select all code blocks within .franklin-content
...
codeBlocks.forEach(codeBlock => {
  ...
  // Define the screen width breakpoints for iPhone SE and iPhones
  ...
  // Function to hide the button if the screen size is iPhone SE or iPhone
  if (window.outerWidth <= iPhoneSEWidth || window.outerWidth <= iPhoneWidth) {
    button.style.position = 'absolute';
      ...
      navigator.clipboard.writeText(codeBlock.textContent)
        .then(() => {
          ...
          setTimeout(() => {
            ...
            // Check if the clicked element has the class "changeHref"
            if (clickedElement.classList.contains('fa-copy')) {
              // // Prevent default action of the link
              // event.preventDefault();

              // Change the href attribute of the clicked element
              clickedElement.style.backgroundImage = 'url("../nlpwme/assets/clipboard-check-solid.svg")';

              console.log('the button fa-copy is present');
            }

          }, 1000);

          setTimeout(() => {
            clickedElement.style.backgroundImage = 'url("../nlpwme/assets/clipboard-solid.svg")';
          }, 3000);
