...
document.addEventListener("DOMContentLoaded", function() {
            ...
            codeBlocks.forEach(block => {
                ...
                if (isSmallScreen) {
                    button.classList.add('small-screen');
                }
                ...
                button.addEventListener('click', function() {
                    ...
                    navigator.clipboard.writeText(text).then(() => {
                        ...
                        if (button.classList.contains('copied')) {
                            button.style.backgroundColor = '#616161'; // Hover background color
                        }
                        ...
                        setTimeout(() => {
                            ...
                            if (isSmallScreen) {
                              button.style.backgroundColor = '#017da5';
                            }
                        }, 2000);
                    });
                });
                ...
                button.addEventListener('mouseout', function() {
                    if (!button.classList.contains('copied')) {
                        button.style.backgroundColor = '#017da5'; // Initial background color
                    }
                });
